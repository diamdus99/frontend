const myTheme = {
  ...
  alert: {
    ...
    withClose: 'pr-12',
    success: 'bg-blue-50 text-emerald-900 dark:bg-blue-950 dark:text-white',
    ...
    info: 'bg-blue-50 text-blue-900 dark:bg-blue-950 dark:text-white',
    icon: {
      base: 'h-5 w-5',
  ...
  badge: {
    ...
    success:
      'text-emerald-600 bg-blue-100 dark:bg-blue-800 dark:text-emerald-100',
