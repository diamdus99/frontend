        ...
        <div>
          ...
          <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <section aria-labelledby="products-heading" class="pb-24 pt-6">
              ...
              {/* <Button>Round</Button>&nbsp;
        <Button>Princess</Button>&nbsp;
        <Button>Asher</Button>&nbsp;
        <Button>Emerald</Button>&nbsp;
        <Button>Heart</Button>&nbsp;
        <Button>Marquise</Button>&nbsp;
        <Button>Oval</Button>&nbsp; */}
                  ...
                  <div class="border-b border-gray-200 py-6">
                    <h3 class="-my-3 flow-root">
                      <button
                        ...
                        aria-expanded="false"
                      >
                        <span class="font-medium text-gray-900">Carat</span>
                        <span class="ml-6 flex items-center">
                          {/* <!-- Expand icon, show/hide based on section open state. --> */}
                          <svg
                            class="h-5 w-5"
                  ...
                  <div class="border-t border-gray-200 px-4 py-6">
                    <h3 class="-mx-2 -my-3 flow-root">
                      <button
                        ...
                        aria-expanded="false"
                      >
                        <span class="font-medium text-gray-900">ShortCut</span>
                        <span class="ml-6 flex items-center">
                          {/* <!-- Expand icon, show/hide based on section open state. --> */}
                          <svg
                            class="h-5 w-5"
                  ...
                  <div class="bg-white">
                    <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                      ...
                      <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                        {data?.map((i) => (
                          <div class="group relative aspect-w-1 aspect-h-1">
                      ...
                      {/* {JSON.stringify(data.map((i) => i.imagelink))} */}
                      {/* <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
