...
const LandingPage = () => {
  return (
    <div>
      ...
      <section className="flex bg-center bg-no-repeat ">
        <video
          ...
          <div className="tc wf gg qq">
            ...
            <div className="animate_left xc gn gg jn/2 i">
              <div>
                ...
                />
                <img src="about-01.png" alt="About" className="ib" />
                <img src="about-02.png" alt="About" />
              </div>
              <div>
                <img src="shape-06.svg" alt="Shape" />
                <img src="about-03.png" alt="About" className="ob gb" />
                <img src="shape-07.svg" alt="Shape" className="bb" />
              </div>
            </div>
