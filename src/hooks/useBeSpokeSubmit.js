...
const useBeSpokeSubmit = (id, data) => {
  ...
  const onSubmit = async (data) => {
    console.log('onSubmit', handleSubmit, register, data);
    try {
  ...
  const handleReferenceNumberSlug = (referenceNumber) => {
    console.log('handleReferenceNumberSlug', referenceNumber);
    setValue('referenceNumber', referenceNumber);
  };

  const handleProductSlug = (product) => {
    console.log('handleProductSlug', handleSubmit, register);
    console.log('handleProductSlug');
    console.log(handleSubmitForAll, 'handleSubmitForAll', product);
  };
...
export default useBeSpokeSubmit;
...
// const useBeSpokeSubmit = (id) => {
//   const location = useLocation();
//   const { isDrawerOpen, closeDrawer, setIsUpdate, lang } =
//     useContext(SidebarContext);

//   const { data: attribue } = useAsync(BespokeServices.getShowingAttributes);
...
//     }
//     console.log('Swapnil Submit', JSON.stringify(values));
