...
import suppliersidebar from '@/routes/suppliersidebar';
import vendorsidebar from '@/routes/vendorsidebar';
    ...
    <div className="py-4 text-gray-500 dark:text-gray-400">
      ...
      <ul className="mt-8">
        {adminInfo.role === 'Admin'
          ...
          : adminInfo.role === 'Vendor'
          ? vendorsidebar.map((route) =>
              route.routes ? (
                <SidebarSubMenu route={route} key={route.name} />
              ) : (
                <li className="relative" key={route.name}>
