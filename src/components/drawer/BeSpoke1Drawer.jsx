...
import useBeSpoke1Submit from '@/hooks/useBeSpoke1Submit';

//internal import

const BeSpoke1Drawer = ({ id }) => {
  React.useEffect(() => {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="block" id="block">
          {tapValue === 'Basic Info' && (
            <div className="px-6 pt-8 flex-grow w-full h-full max-h-full pb-40 md:pb-32 lg:pb-32 xl:pb-32">
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <LabelArea label="refrence number" />
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <LabelArea label="Supporting Images" />
                <div className="col-span-8 sm:col-span-4">
                  <Uploader
                    product
                    folder="product"
...
export default React.memo(BeSpoke1Drawer);
